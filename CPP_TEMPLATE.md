...
- Replace all occurrences of "{#PROJECT_TITLE#}" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `{#PROJECT_TITLE#}` means the name of the project, while `{#PROJECT_TITLE#}` is used in file names.
  - Remember to rename the `include/{#PROJECT_TITLE#}` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
